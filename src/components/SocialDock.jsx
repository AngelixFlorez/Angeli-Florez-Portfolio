...
export default function SocialDock() {
  ...
  const items = [
    ...
    { icon: WhatsAppIcon, label: 'WhatsApp', href: personalInfo.social.whatsapp },
    { icon: GmailIcon, label: t('contact', 'email'), href: personalInfo.social.gmail },
  ]
          ...
          return (
            ...
            >
              <motion.button
                ...
                className="relative rounded-2xl p-2.5 transition-colors hover:shadow-lg hover:shadow-primary/20"
                onClick={() => {
              ...
              <AnimatePresence>
                {tooltip === i && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 5 }}
                    className="absolute -top-8 left-1/2 -translate-x-1/2 px-2 py-1 rounded-md bg-surface border border-white/10 text-xs text-text-secondary whitespace-nowrap"
                  >
                    {item.label}
                  </motion.div>
                )}
